...
/**
 * Created by nopphon on 5/14/16.
 */
public class ParamTrack {
    public static final String MODE_EXPLORE = "/explore";
    public static final String MODE_CHART = "/charts";
    public static final String POPULAR = "/Popular+Music";
    ...
    public static final String GENRE = "&genre=";
        ...
        public class  GenreList{
            public static final String ALL = "soundcloud:genres:all-music";
            public static final String ELECTRONIC = "soundcloud:genres:electronic";
            public static final String ALTERNATIVEROCK  = "soundcloud:genres:alternativerock";
            ...
            public static final String DANCEEDM  = "soundcloud:genres:danceedm";
            public static final String DANCEHALL  = "soundcloud:genres:dancehall";
            public static final String DEEPHOUSE  = "soundcloud:genres:deephouse";
            public static final String DISCO =  "soundcloud:genres:disco";
            public static final String DRUMBASS =  "soundcloud:genres:drumbass";
            public static final String DUBSTEP  = "soundcloud:genres:dubstep";
            public static final String FOLKSINGERSONGWRITER  = "soundcloud:genres:folksingersongwriter";
            public static final String HIPHOPRAP =  "soundcloud:genres:hiphoprap";
            public static final String HOUSE =  "soundcloud:genres:house";
            public static final String INDIE  = "soundcloud:genres:indie";
            public static final String JAZZBLUES  = "soundcloud:genres:jazzblues";
            ...
            public static final String RBSOUL =  "soundcloud:genres:rbsoul";
            ...
            public static final String SOUNDTRACK =  "soundcloud:genres:soundtrack";
